...
if __name__ == '__main__':
    read_gauss_log("../sol_data/raw/csd20_gas_coms_small/*.log", "csd20_small", cpus=16)
    # read_gauss_log("../sol_data/raw/csd20_gas_coms/*.log", "csd20_gas")
    # read_gauss_log("../sol_data/raw/csd20_water_coms/*.log", "csd20_water")
    # read_gauss_log("../sol_data/raw/csd20_oct_coms/*.log", "csd20_oct")

...
if __name__ == '__main__':
    ...
    read_gauss_log("../sol_data/raw/csd20_gas_coms/*.log", "csd20_gas", cpus=32, save_folder="/ext/gas")
    read_gauss_log("../sol_data/raw/csd20_water_coms/*.log", "csd20_water", cpus=32, save_folder="/ext/water")
    read_gauss_log("../sol_data/raw/csd20_oct_coms/*.log", "csd20_oct", cpus=32, save_folder="/ext/oct")

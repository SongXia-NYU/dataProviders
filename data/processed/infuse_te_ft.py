...
def infuse_te_ft_lipop():
    calc_mol_prop = torch.load("lipop_embed160_exp333_dataset.pt")
    ...
    setattr(data[0], "octEnergy", -data[0].watOct/23.06035 + data[0].watEnergy)
    setattr(data[0], "CalcOct", (data[0].octEnergy - data[0].gasEnergy)*23.06035)
    ...
    torch.save(data, "lipop_te_mam_ft_mmff_exp333.pt")
